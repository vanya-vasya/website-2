...
#### A) Secure-processor отправляет webhook на другой URL
**Проверка:**
- Зайдите в Secure-processor Dashboard
- Transactions → Найдите транзакцию
- Проверьте "Notification URL"

#### B) Secure-processor ждет ответа 200 OK
**Текущий код:**
```typescript
...
#### C) Secure-processor отправляет webhook с задержкой
**Решение:**
...
Вы завершили оплату на странице Secure-processor?
...
2. Ищите строку "Secure-processor Webhook Received"
3. Если не найдено - проверьте Secure-processor Dashboard
